...
namespace Minibank.Core.Tests
{
    public class BankAccountServiceTests
    {
        ...
        [Fact]
        public async Task CreateBankAccount_SuccessPath_ShouldCheckRepositoryCall()
        {
        ...
        [Fact]
        public async Task UpdateBankAccount_SuccessPath_ShouldCheckRepositoryCall()
        {
        ...
        public async Task MakeMoneyTransfer_SuccessPath_ShouldIncreaseMoneyOnTargetAccount(bool differentUserId,
